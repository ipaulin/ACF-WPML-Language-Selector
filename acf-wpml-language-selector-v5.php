	...
	function render_field( $field ) {
		...
		switch ($field['type_of_selector']) {
			...
			case 'radio':
				...
				<?php foreach($langs as $lang) { ?>
						<li>
							<label><?php echo $lang['native_name']; ?></label>
							<input type="radio" value="<?php echo $lang['language_code']; ?>"
			...
			<?php foreach($langs as $lang) { ?>
					<li>
						<label><?php echo $lang['native_name']; ?></label>
						<input type="checkbox" value="<?php echo $lang['language_code']; ?>"
						 name="<?php echo $field['name']; ?>[]"
						<?php echo $this->checked($lang['language_code'], $field['value']); ?>  />
					</li>
			<?php } ?>
